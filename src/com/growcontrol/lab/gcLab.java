...
//	}
	...
	protected void displayLogo() {
		...
		final Ansi.Color bgcolor = Ansi.Color.CYAN;
		out.println();
		// line 1
		...
		out.println(Ansi.ansi()
			...
			.boldOff().a("         ")
			/* D */ .fg(Ansi.Color.WHITE).a(",`--',")
					.a("                                    ")
			.reset() );
		// line 3
		out.println(Ansi.ansi()
			.a(" ").bg(bgcolor).a("          ")
					.fg(Ansi.Color.CYAN).a("Lab            ")
			/* D */ .fg(Ansi.Color.MAGENTA).a(". _\\/_ .")
			/* F */ .fg(Ansi.Color.YELLOW).a("_")
					.a("                   ")
			.reset() );
		// line 4
		out.println(Ansi.ansi()
			.a(" ").bg(bgcolor).a(" ").a("                 ")
			/* C */ .fg(Ansi.Color.BLUE).a(".\\|/.   ")
			/* D */ .fg(Ansi.Color.YELLOW).a("`. /\\ .'   ")
			/* E */ .fg(Ansi.Color.WHITE).a(".\\|/.     ")
			/* F */ .fg(Ansi.Color.WHITE).a("_(_)_                 ")
			.reset() );
		// line 5
		out.println(Ansi.ansi()
			.a(" ").bg(bgcolor).a("                 ")
			/* C */ .fg(Ansi.Color.BLUE).a("-(:)-     ")
			/* D */ .fg(Ansi.Color.MAGENTA).a("\"||\"     ")
			/* E */ .fg(Ansi.Color.YELLOW).a("-(:)-    ")
			/* F */ .fg(Ansi.Color.WHITE).a("(_)@(_)        ")
			/* H */ .fg(Ansi.Color.WHITE).a(".\\V/,   ")
			.reset() );
		// line 6
		out.println(Ansi.ansi()
			.a(" ").bg(bgcolor).a("         ")
			/* B */.fg(Ansi.Color.BLUE).a("\\V/,    ")
			/* C */.fg(Ansi.Color.GREEN).a("\"/|\\\"      ")
			/* D */.fg(Ansi.Color.GREEN).a("|| /\\   ")
			/* E */.fg(Ansi.Color.WHITE).a("\"/|\\\"    ")
			/* F */.fg(Ansi.Color.WHITE).a("./(_)          ")
			/* H */.fg(Ansi.Color.WHITE).a("\\`V'/   ")
			.reset() );
		// line 7
		out.println(Ansi.ansi()
			.a(" ").bg(bgcolor).a(" ")
			/* A */.fg(Ansi.Color.GREEN).a(".vVv.   ")
			/* B */.fg(Ansi.Color.RED).a("`V'      ")
			/* C */.fg(Ansi.Color.GREEN).a("'|'     ")
			/* D */.fg(Ansi.Color.RED).a("/\\||//\\)   ")
